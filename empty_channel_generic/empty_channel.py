def empty_channel(meshType, dt, nsteps, vRange, T = None)
    ...
    if meshType = "Structured":
        input_file = "01_empty_sym_structFluid.mdpa"
        #input_file = "triangle_testFluid.mdpa"
        output_file = "01_empty_sym_structFluid.OUT"
